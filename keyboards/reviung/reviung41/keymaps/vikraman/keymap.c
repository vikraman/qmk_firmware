...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    QK_GESC,          LCTL_T(KC_A),   LALT_T(KC_S),   LGUI_T(KC_D),   LSFT_T(KC_F),   KC_G,           KC_H,           RSFT_T(KC_J),   RGUI_T(KC_K),   LALT_T(KC_L),   RCTL_T(KC_SCLN), KC_QUOT,
  ...
  [_COLEMAK] = LAYOUT(
    ...
    QK_GESC,          LCTL_T(KC_A),   LALT_T(KC_R),   LGUI_T(KC_S),   LSFT_T(KC_T),   KC_G,           KC_M,           RSFT_T(KC_N),   RGUI_T(KC_E),   LALT_T(KC_I),   RCTL_T(KC_O),    KC_QUOT,
  ...
  [_ADJUST] = LAYOUT(
    UG_VALU,   UG_SATU, UG_HUEU,  UG_NEXT,  QWERTY,    UG_TOGG,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    UG_VALD,   UG_SATD, UG_HUED,  UG_PREV,  COLEMAK,   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
