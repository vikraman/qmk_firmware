...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] = LAYOUT(
    UG_VALU,   UG_SATU, UG_HUEU,  UG_NEXT,  UG_SPDU,   UG_TOGG,            EE_CLR,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  QWERTY,
    UG_VALD,   UG_SATD, UG_HUED,  UG_PREV,  UG_SPDD,   VK_TOGG,            QK_RBT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  COLEMAK,
