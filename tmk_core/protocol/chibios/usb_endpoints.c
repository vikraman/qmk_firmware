...
// clang-format on
    ...
    [USB_ENDPOINT_IN_TRACKPAD] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, TRACKPAD_EPSIZE, TRACKPAD_IN_EPNUM, TRACKPAD_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(sizeof(report_trackpad_t))),
#endif
...
#if defined(PRECISION_TRACKPAD_ENABLE)
    [TRACKPAD_INTERFACE] = USB_ENDPOINT_IN_TRACKPAD,
#endif
};
